#!/usr/bin/env python
"""
Convenience script to run tests for wagtail-orderable-viewset package.
...
# Add project root and test dir to sys.path for reliable imports
...
def run_tests(
    ...
    Args:
        test_labels: List of test labels to run (default: ['wagtail_orderable_viewset'])
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run wagtail-orderable-viewset tests",
...
Examples:
  ...
  python runtests.py --keepdb                  # Keep test database for faster subsequent runs
    ...
    parser.add_argument(
        "test_labels",
        nargs="*",
        help="Specific test labels to run (default: test)",
        default=["test"],
    )
    ...
    # Do not force wagtail_orderable_viewset.tests prefix; use as provided
